    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand px-4 py-3 m-0"
                ...
                <img src="{{ asset('template/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img" width="26"
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/beranda') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/project*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
